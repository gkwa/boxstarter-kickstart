...
wget --no-verbose --timestamping --no-check-certificate https://raw.githubusercontent.com/TaylorMonacelli/win_settings/master/settings.ps1 https://raw.githubusercontent.com/TaylorMonacelli/win_settings/master/include.ps1
